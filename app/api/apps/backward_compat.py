...
async def deprecated_chat_completions(chat_id):
    ...
    return jsonify({"code": 404, "message": "Chat functionality removed. Use RAG SDK for retrieval."}), 404
...
async def deprecated_agents_openai_chat_completions(agent_id, tenant_id=None):
    ...
    return jsonify({"code": 404, "message": "Agent functionality removed. Use RAG SDK for retrieval."}), 404
